...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0015_vendor_outsource.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0016_fleet.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0017_fleet_registers.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0018_fleet_drivers_status.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0019_fleet_outstanding.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0020_status_inactive.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0021_warehouse.sql
...
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0026_tembak_releases.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0027_tembak_code.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0028_slip_jenis_potongan.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0029_contract_distance.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0030_delivery_stage.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0031_truck_stage.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0032_slip_adjustments.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0033_selisih_bbm_detail.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0034_driver_debt.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0035_potongan_split.sql
psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/migrations/0036_driver_loans.sql
```
...
applied yet (e.g. just `0019_fleet_outstanding.sql`).
